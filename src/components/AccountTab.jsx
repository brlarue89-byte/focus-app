...
export default function AccountTab() {
  ...
  return (
    <>
      ...
      {!pro && <button className="btn-primary" onClick={handleSubscribe} disabled={subscribing} style={{ marginBottom: 12 }}>{subscribing ? 'Redirecting…' : `Upgrade to Pro — $${PRICE}/mo`}</button>}
